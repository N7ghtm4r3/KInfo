 ...
 *
 * @property destination The destination network address encoded as four bytes for `IPv4` or sixteen bytes for `IPv6`
 * @property prefixLength The number of leading bits in the destination network mask, or `-1` when not available
 * @property gateway The next hop address, or an empty array for a directly attached route
 * @property interfaceName The name of the outgoing network interface, or an empty string when not available
 * @property interfaceIndex The index of the outgoing network interface, or `-1` when not available
 * @property metric The route cost used to select between routes to the same destination, or `-1` when not available
